...
import br.com.zypacademy.casaDoCodigo.controller.request.CategoriaRequest;
...
public class CategoriaController {
	...
	@PostMapping
	public ResponseEntity<CategoriaDto> criar(@RequestBody @Valid CategoriaRequest form, HttpServletResponse response) {
